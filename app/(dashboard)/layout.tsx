...
export default function DashboardLayout({
  ...
  const SidebarContent = () => (
    <>
      ...
      <nav className="flex-1 p-3 flex flex-col gap-0.5 overflow-y-auto">
        ...
        <Link href="/turnos" className={navItem("/turnos")}>
          <span className={navIcon("/turnos")}>◷</span>
          Turnos
        </Link>
        ...
        <Link href="/pagos" className={navItem("/pagos")}>
          <span className={navIcon("/pagos")}>$</span>
          Historial de Pagos
        </Link>

        {sectionLabel("Sistema")}
        <Link href="/configuracion" className={navItem("/configuracion")}>
          <span className={navIcon("/configuracion")}>⚙</span>
          Perfil del Taller
        </Link>
      </nav>
      ...
      <div className="p-3 border-t" style={{ borderColor: "#2e3650" }}>
        ...
        >
          ...
          <div>
            <div className="text-sm font-semibold" style={{ color: "#dde3f0" }}>
              Administrador
            </div>
  ...
  return (
    ...
    >
      ...
      <aside
        id="main-sidebar"
        className="hidden lg:flex w-60 min-w-[240px] flex-col border-r z-30"
      ...
      <aside
        id="main-sidebar"
        className={`fixed top-0 left-0 h-full w-72 flex flex-col border-r z-30 lg:hidden transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div
          className="flex lg:hidden items-center gap-3 px-4 py-3 border-b flex-shrink-0"
          style={{ background: "#202637", borderColor: "#2e3650" }}
        >
          <button
            onClick={() => setSidebarOpen(true)}
            className="w-9 h-9 rounded-lg flex items-center justify-center transition-all"
            style={{ background: "#252b3b", color: "#a8b4cc" }}
          >
